            ...
            <div className="container d-flex justify-content-center align-items-center h_100">
                <div className="row">
                    <div className="col-12 col-sm-12 col-md-6 text-center my-5">
                        <img src={imgLogin} alt="Login" width="800" className="img-fluid"/>
                    </div>
                    <div className="col-12 col-sm-12 col-md-6 d-flex justify-content-center align-items-center">
                        <div className="card w-100">
                            <div className="card-body">
                                ...
                                <h3 className="card-title text-center my-4">Inicia Sesión con tu cuenta</h3>
                                <form>
                                    <div className="input-group my-4">
                                        <span className="input-group-text" id="email">Correo</span>
                                    ...
                                    <div className="d-flex justify-content-center align-items-center">
                                        ...
                                        <button type="button" className="btn btn-outline-primary mx-2 my-4">Iniciar sesión</button>
                                        <button type="button" className="btn btn-outline-secondary my-4">Crear cuenta nueva </button>
                                    </div>
                                </form>
                            </div>
                        </div>
